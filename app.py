...
with col1:
    ...
    st.success("** Furniture Set** — Coffee Table + Side Table bought together 15x more than random. Always display together in store.")
...
with col3:
    ...
    st.warning("** Return Rate Alert** — OMNWEB has 14% return rate — 6x company average. Investigate quality and delivery.")
